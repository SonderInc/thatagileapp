...
interface AppState {
  ...
  viewMode: 'epic' | 'feature' | 'product' | 'team' | 'backlog' | 'list' | 'landing' | 'add-product' | 'add-company' | 'register-company' | 'invite-user' | 'licence' | 'company-profile' | 'settings' | 'nomenclature' | 'import-backlog' | 'user-profile' | 'teams-list' | 'planning' | 'app-admin' | 'no-company' | 'account-load-failed';
